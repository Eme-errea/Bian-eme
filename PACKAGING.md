...
| **Lianxin** (Lily) | 🟡 Esperando respuesta | Entendió el diseño (2 piezas), propuso llamada, sin precio/MOQ todavía |
| **Jarsking** | ⚪ Sin respuesta | Consulta enviada 21/06 |
...
### Uzone Packaging — David Xu
**Mail:** info@uzonepackaging.com

Propuso fabricar los frascos en **cerámica** en vez de vidrio, por la forma orgánica que buscamos.

- **MOQ:** 3.000 unidades **por cada componente** (cuerpo y tapa, por separado) y por tamaño/color → **6.000 piezas en total** para un solo modelo, no 3.000 frascos completos como se entendía al principio.
- **Precio:** USD 3–5/unidad EXW (sin envío)
- **Molde:** USD 700/componente en acero inoxidable (cuerpo + tapa = USD 1.400 total). Alternativa más barata: molde de yeso a USD 500/componente, pero advierte que la calidad del producto baja.
- **Producción:** 40–50 días. Recomienda envío por barco (más económico).
...
### Lianxin — Lily
**Mail:** lianxin@lansenpack.com / lily@lansenpack.com

- Tuvo problemas para abrir las imágenes de referencia al principio (resuelto reenviando como adjuntos directos).
- Le explicamos la construcción: cuerpo sólido de una sola pieza + tapa a rosca con el mosquetón fijado a la tapa (2 piezas en total).
- Propusimos agendar una llamada para revisar el diseño juntos.

**Estado:** esperando su respuesta. Todavía no dio ningún número de MOQ ni precio.

---

### Cosmopak — Dalton Maier
**Mail:** sales@cosmopak.com / daltonm@cosmopak.com

- MOQ inicial: 15.000 unidades por SKU.
- Le explicamos que es nuestra primera tirada, con cantidades muy por debajo de eso.
- Respondió que para proyectos custom pueden bajar a **10.000 unidades por SKU**, pero no menos — y aclaró que **no tienen packaging en stock**, todo es a medida.

**Estado:** 10.000/SKU sigue siendo alto para una primera tirada. Falta decidir si responder pidiendo algo más chico o descartarlo.

---

### GP Bottles — Ben
**Mail:** ben@gpbottles.com

- Primer contacto: presentó su servicio, MOQ de 10.000 piezas por diseño.
- Le marcamos que ese MOQ era alto; pidió ver el diseño de referencia primero para dar un MOQ flexible y precio estimado.
- Le mandamos las imágenes de referencia (21/06).
- Mandamos un mensaje de seguimiento (24/06) porque no respondió.

**Estado:** sin respuesta hace varios días.

---

### Apogee Dev LLC — Rob Lynch / Jordan Kolb
**Mail:** Rlynch@apogeedevllc.com (cc jKolb@apogeedevllc.com)

Contacto por formulario web. Conversación más fluida que el resto:

- Mandó precios preliminares.
- Agendamos una llamada para **viernes 26/06, 1pm hora Buenos Aires / 12pm NYC**.
- Mandó el link de Zoom.

**Estado:** llamada programada para hoy.

---

### FEEMIO — descartado
**Mail:** info@feemio.com

Son una fábrica industrial pura, no venden en cantidades chicas. **MOQ: 300.000 unidades.** No es viable para una primera tirada.

---

### Sin respuesta todavía

- **Jarsking** — info@jarsking.com (consulta enviada 21/06)
- **Packafill** — sale@packafill.com (consulta enviada 21/06)
- **Roetell** — ventas@roetell.com (consulta enviada 21/06)

---

### MOSH® Micelio — opción de packaging de presentación
**Instagram:** [@mosh.micelio](https://www.instagram.com/mosh.micelio/)

No es un proveedor de frascos — hacen **packaging sustentable de micelio de hongos** (cajas/estuches). Podría usarse para la caja de envío o el estuche de presentación del perfume, no para el frasco en sí. Aporta una historia de sustentabilidad a la marca. **Decisión pendiente: evaluar junto con Bianca.**
