...
Vista explotada con las siguientes partes numeradas:

```
1. Mosquetón (Carabiner)
   ↓
...
- **Vista frontal** — con todas las cotas
- **Vista lateral**
- **Vista superior**
- **Vista inferior**
...
Superficie plana de estabilidad. Perímetro redondeado. Radio ≈ 6 mm.

## Material

**A definir con Facu en Etapa 1.** Opciones en evaluación: vidrio esmerilado, cerámica, u otro material que Facu proponga tras su análisis de factibilidad productiva.

> **Nota de peso:** la cerámica fue explorada con Uzone (USD 3–5/u, MOQ 3.000) pero genera preocupación de peso para un frasco pensado para colgar. El material final depende de la evaluación de Facu sobre forma orgánica + mecanismo + viabilidad de fabricación.

## Acabado

Semi-opaco · 15–20 GU Satin (bajo brillo)
...
**Superellipse (Squircle)** con bordes muy suavizados. No es esfera ni cilindro.

## Dimensiones

| Atributo       | Valor                     |
| -------------- | ------------------------- |
| Ancho          | ≈95% del ancho del cuerpo |
| Altura         | ≈28% del ancho            |
...
Mismo material que el cuerpo del frasco. A definir con Facu.
...
| ---------- | ----------------------- | -------------- |
| Bottle     | **A definir con Facu** (vidrio / cerámica / otro) | Satin 15–20 GU |
| Cap        | **A definir con Facu** (mismo que bottle) | Satin 15–20 GU |
...
```
1. Llenar frasco con perfume
       ↓
2. Insertar bomba + tubo dip
       ↓
...
| Color Match            | Dentro de ΔE ≤ 2 (colorímetro) |
| Carabiner Load Test    | — *(a definir carga kg)*  |
